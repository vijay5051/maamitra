...
import { h, SatoriElement, SatoriNode } from './h';
import { BrandSnapshot, QuoteCardProps } from './types';

export function quoteCard(props: QuoteCardProps, brand: BrandSnapshot): SatoriElement {
