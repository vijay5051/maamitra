...
const realStoryCard_1 = require("./realStoryCard");
...
const REGISTRY = {
    ...
    realStoryCard: realStoryCard_1.realStoryCard,
};
function getTemplate(name) {
    return name in REGISTRY ? REGISTRY[name] : null;
}
exports.TEMPLATE_NAMES = ['tipCard', 'quoteCard', 'milestoneCard', 'realStoryCard'];
