...
const CHIPS_PREGNANT = [
  ...
  "Is it safe to travel at 7 months? ✈️",
...
export default function QuickChips({ onSelect }: QuickChipsProps) {
  ...
  const chips = useMemo(() => {
    ...
    const months = activeKid.ageInMonths ?? null;
  ...
  const greeting = useMemo(() => {
    ...
    if (activeKid.ageInMonths !== undefined) {
